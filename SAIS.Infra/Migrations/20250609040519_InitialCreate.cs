    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ApplicationProgrammeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ApplicantId = table.Column<int>(type: "int", nullable: false),
                    ProgrammeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationProgrammes", x => x.ApplicationProgrammeId);
                    table.ForeignKey(
                        name: "FK_ApplicationProgrammes_Applicants_ApplicantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InformationCollectedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ApplicantId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfficialUses", x => x.OfficialId);
                    table.ForeignKey(
                        name: "FK_OfficialUses_Applicants_ApplicantId",
                        column: x => x.ApplicantId,
                        principalTable: "Applicants",
                        principalColumn: "ApplicantId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applicants_ApplicationDate",
                table: "Applicants",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationProgrammes_ApplicantId_ProgrammeId",
                table: "ApplicationProgrammes",
                columns: new[] { "ApplicantId", "ProgrammeId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OfficialUses_ApplicantId",
                table: "OfficialUses",
                column: "ApplicantId",
                unique: true);
